...
@tag
Feature: To buy a computer
  @file1
  Scenario: To buy a computer
  When click the tab"COMPUTERS"
  And click the desktop
  And click the "Build your own cheap computer"
  And user have to click the add to cart button
  Then user select  the shopping card button
